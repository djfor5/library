...
.card div:first-child span:nth-child(2n-1) {
  font-weight: bold;
}
...
#new-book:active {
  background-color: #84a6b1;
}

#save-book {
  margin-top: 1rem;
  background-color: #90ee90;
  border: 2px solid #508650;
}
...
.toggle-read {
  ...
  border: 2px solid rgb(127, 161, 206);
}
...
.toggle-read:active {
  background-color: rgb(134, 172, 221);
}

.edit {
  background-color: rgb(255, 210, 159);
  border: 2px solid rgb(199, 163, 122);
}
...
.edit:active {
  background-color: rgb(214, 173, 126);
}

.delete {
  background-color: rgb(255, 159, 159);
  border: 2px solid rgb(202, 125, 125);
}
...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;EAGE,sBAAsB;AACxB;;AAEA;EACE,sBAAsB;EACtB,oCAAoC;;EAEpC,SAAS;AACX;;AAEA;EACE,mCAAmC;EACnC,cAAc;EACd,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;;EAEjB,aAAa;EACb,+BAA+B;EAC/B,SAAS;AACX;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;;EAEhB,aAAa;EACb,4DAA4D;EAC5D,SAAS;AACX;;AAEA;EACE,yBAAyB;;EAEzB,yBAAyB;EACzB,kBAAkB;EAClB,+BAA+B;;EAE/B,kBAAkB;;EAElB,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,WAAW;AACb;;AAEA;EACE,aAAa;EACb,+BAA+B;EAC/B,gBAAgB;AAClB;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,iBAAiB;EACjB,kBAAkB;EAClB,+BAA+B;;;EAG/B,eAAe;;EAEf,eAAe;AACjB;;AAEA;EACE,mBAAmB;EACnB,qBAAqB;EACrB,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,yBAAyB;EACzB,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,WAAW;AACb;;AAEA;EACE,oCAAoC;EACpC,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;EACpC,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;EACpC,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC","sourcesContent":["*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: system-ui;\n  background-color: rgb(252, 252, 252);\n\n  margin: 0;\n}\n\nmain {\n  max-width: min(1200px, 100% - 4rem);\n  margin: 0 auto;\n  margin-top: 2rem;\n  margin-bottom: 2rem;\n}\n\nform div {\n  margin-left: 2rem;\n\n  display: grid;\n  grid-template-columns: auto 1fr;\n  gap: 1rem;\n}\n\nform input {\n  max-width: max-content;\n}\n\nli {\n  list-style: none;\n}\n\n#cards {\n  margin-top: 1rem;\n\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));\n  gap: 1rem;\n}\n\n.card {\n  background-color: #ebebeb;\n\n  border: 2px solid #b6b6b6;\n  border-radius: 5px;\n  box-shadow: 2px 2px 4px #c0c0c0;\n\n  padding: 1rem 1rem;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  gap: 0.5rem;\n}\n\n.card div:first-of-type {\n  display: grid;\n  grid-template-columns: auto 1fr;\n  gap: 0.5rem 1rem;\n}\n\n.capitalise-first::first-letter {\n  text-transform: capitalize;\n}\n\n.card div:first-child span:nth-child(2n-1) {\n  font-weight: bold;\n}\n\n.card span {\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.button {\n  color: black;\n  font-weight: bold;\n  border-radius: 3px;\n  box-shadow: 2px 2px 4px #d8d8d8;\n\n\n  padding: 0.5rem;\n\n  cursor: pointer;\n}\n\n#new-book {\n  margin-bottom: 1rem;\n  text-decoration: none;\n  background-color: #add8e6;\n  border: 2px solid #617981;\n}\n\n#new-book:hover {\n  background-color: #97bdca;\n}\n\n#new-book:active {\n  background-color: #84a6b1;\n}\n\n#save-book {\n  margin-top: 1rem;\n  background-color: #90ee90;\n  border: 2px solid #508650;\n}\n\n#save-book:hover {\n  background-color: #7bce7b;\n}\n\n#save-book:active {\n  background-color: #6cb46c;\n}\n\n#update-book {\n  margin-top: 1rem;\n  background-color: #c890ee;\n  border: 2px solid #694c7c;\n}\n\n#update-book:hover {\n  background-color: #ac7ccc;\n}\n\n#update-book:active {\n  background-color: #936aaf;\n}\n\n#cancel {\n  margin-top: 1rem;\n  margin-bottom: 1rem;\n  background-color: #ff8170;\n  border: 2px solid #8d463d;\n}\n\n#cancel:hover {\n  background-color: #e27162;\n}\n\n#cancel:active {\n  background-color: #c26154;\n}\n\n.card-buttons {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 0.5rem;\n}\n\n.toggle-read {\n  background-color: rgb(159, 201, 255);\n  border: 2px solid rgb(127, 161, 206);\n}\n\n.toggle-read:hover {\n  background-color: rgb(142, 181, 231);\n}\n\n.toggle-read:active {\n  background-color: rgb(134, 172, 221);\n}\n\n.edit {\n  background-color: rgb(255, 210, 159);\n  border: 2px solid rgb(199, 163, 122);\n}\n\n.edit:hover {\n  background-color: rgb(228, 185, 137);\n}\n\n.edit:active {\n  background-color: rgb(214, 173, 126);\n}\n\n.delete {\n  background-color: rgb(255, 159, 159);\n  border: 2px solid rgb(202, 125, 125);\n}\n\n.delete:hover {\n  background-color: rgb(231, 131, 131);\n}\n\n.delete:active {\n  background-color: rgb(223, 126, 126);\n}"],"sourceRoot":""}]);
// Exports
